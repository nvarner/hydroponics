...
.mdc-button {
  ...
  .mdc-button.mdc-button--accent {
    ...
    .mdc-button.mdc-button--accent::before {
      ...
      @supports (background-color: color(green a(10%))) {
        .mdc-button.mdc-button--accent::before {
          background-color: color(var(--mdc-theme-accent, #304ffe) a(12%)); } }
  ...
  .mdc-button--accent {
    color: #304ffe;
    color: var(--mdc-theme-accent, #304ffe); }
    ...
    .mdc-button--accent.mdc-button--raised {
      ...
      background-color: var(--mdc-theme-accent, #304ffe);
      color: white;
...
.mdc-icon-toggle--accent {
  ...
  .mdc-icon-toggle--accent::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-icon-toggle--accent::before {
        background-color: color(var(--mdc-theme-accent, #304ffe) a(14%)); } }
...
.mdc-ripple-surface {
  ...
  .mdc-ripple-surface--accent::before {
    ...
    @supports (background-color: color(green a(10%))) {
      .mdc-ripple-surface--accent::before {
        background-color: color(var(--mdc-theme-accent, #304ffe) a(16%)); } }
...
.mdc-theme--accent {
  ...
  color: var(--mdc-theme-accent, #304ffe) !important; }
...
.mdc-theme--accent-bg {
  ...
  background-color: var(--mdc-theme-accent, #304ffe) !important; }
